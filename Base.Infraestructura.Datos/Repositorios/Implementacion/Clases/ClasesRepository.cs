...
{
    public class ClasesRepository : BaseRepository<ClasesEntity>, IClasesRepository
    {
        private readonly DataBaseContext _context;
        public ClasesRepository(DataBaseContext context, ClaimsPrincipal user) : base(context, user)
        {
            _context = context;
        }
    }
